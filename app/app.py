...
def lambda_handler(event, context):
    ...
    try:
        ...
        for key, value in found_row.iterrows():
            ...
            cosine_idx = key
            break
        print("STAGE 0 complete - Found the corresponding found_row = {}, idx={}, cosine_idx={} for the title {}."
              .format(found_row, idx, cosine_idx, title))
        ...
        print(f"Stage 1 complete - Found movie indices = {movie_indices} for top 20 titles that share the same cosine "
        ...
        print("Stage 2 completed. Successfully fetched the title, vote count, vote average, year and id ")
        print(movies)
        ...
        print("Stage 3 completed. Successfully applied SVD predict() on the list of 20 movie indices.")
